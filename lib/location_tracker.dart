...
class LocationTracker {
  ...
  Future<void> _handleLocationUpdate(Position position) async {
    ...
    try {
      ...
      final currentLocation = await LocationService.getUserLocation(_currentUserId!);
      ...
      if (currentLocation != null) {
        ...
        double distance = LocationService.calculateDistance(
          savedLat, savedLng, position.latitude, position.longitude,
        );
        ...
        print('Initial location saved: ${position.latitude}, ${position.longitude}');
      }
    } catch (e) {
